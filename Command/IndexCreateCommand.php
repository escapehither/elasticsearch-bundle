...
class IndexCreateCommand extends ContainerAwareCommand
{
    ...
    {
        $this
            ->setName('escapehither:esm:index:create')
            ->setDescription('Create an Elastic search index')
            ->setHelp('This command allows you to create an index ...')
        ;
    }
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        try {
            $index->create();
            $output->writeln('The Index : '.$indexName.' has been successfully created');
        } catch (\Exception $e) {
